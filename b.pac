// Proxy Auto-Config file generated by autoproxy2pac, 2015-07-24 19:12:09
function FindProxyForURL(url, host) {
    var autoproxy = 'PROXY 170.178.188.217:25';
...
function FindProxyForURLByAutoProxy(url, host) {
    ...
    do {
        if (autoproxy_host.hasOwnProperty(host)) {
            return 'PROXY 170.178.188.217:25';
        }
